...
class Follower:
        ...
        def image_callback(self, msg):
                ...
                if len(corners) > 0:
                        ...
                        if tvec[0][0][2] <= 90 and self.stop_flag:
                ...
                if M1['m00'] > 0:
                    ...
                    self.twist.linear.x = 0.6-abs(err)*0.02 if  (0.5-abs(err)*0.01)>0.3 else 0.3
                    self.twist.angular.z = (err*90.0/160)/15*1.1
                    if self.d_count:
                        self.twist.angular.z = self.twist.angular.z + 0.001*(err-self.last_err)*90.0/160
